...
public final class FiguraServerAvatarManager {
    ...
    /**
     * Hashes of avatars currently held in memory. Cleanup skips these - a handle exists because
     * the avatar is being streamed or was just touched, and deleting its files underneath would
     * break the transfer in flight.
     */
    public java.util.Set<Hash> loadedAvatars() {
        return new java.util.HashSet<>(avatars.keySet());
    }
